...
const ModalCloseBtn = ({ onClick, text }: ModalCloseBtnProps) => {
    return (
        <Button
            className="pam:flex !pam:h-[37px] !pam:w-[106px] pam:items-center pam:justify-center pam:gap-2 !pam:px-4 !pam:py-2 pam:font-bold sm:!pam:h-[51px] sm:!pam:w-[151px] pam:sm:pam:gap-4"
            variant="secondary"
            onClick={onClick}
        >
