...
const DepositToAddress = ({
    ...
    return (
        <div className="pam:flex pam:w-full pam:flex-col pam:gap-4 pam:max-sm:!pam:h-full pam:max-sm:pam:pb-[68px]">
            ...
            <div className="pam:flex pam:w-full pam:items-center pam:justify-between pam:gap-2 pam:rounded-2xl pam:border pam:border-border-color pam:bg-form-background pam:px-4 pam:py-4 pam:backdrop-blur-md">
            ...
            <div className="pam:flex pam:items-center pam:justify-center pam:gap-2 pam:rounded-2xl pam:border pam:border-border-color pam:bg-form-background pam:px-4 pam:py-4 pam:shadow pam:h-[170px] pam:backdrop-blur-md">
                <QRCode
