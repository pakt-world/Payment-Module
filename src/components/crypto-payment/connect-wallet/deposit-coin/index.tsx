...
export const DepositAvax = ({
	...
	const { sendTransaction, isLoading: txSending, error: txError } = useSendTransaction();
		...
		<div>
			...
			>
				<div className="flex items-center justify-center gap-2">
					<span> Make Payment</span> <span>{isLoadingAll && <Spinner />}</span>
				</div>
			</Button>
		</div>
	);
